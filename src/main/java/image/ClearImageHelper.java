...
public class ClearImageHelper {  
    ...
    public static void main(String[] args) throws Exception{  
        ...
        /*File testDataDir = new File("D:\\image\\checkImg.jpg");//去噪  
        String destDir ="D:\\image\\imagetmp";  
        //cleanImage(testDataDir, destDir);  
        gray("D:\\image\\checkImg.jpg","D:\\image\\imagetmp\\3VG5B1.jpg");//灰度化  */
    	
    	getImagePixel("D:\\image\\checkImg.jpg");
    }
...
//        BufferedImage binaryBufferedImage = new BufferedImage(width, height,BufferedImage.TYPE_BYTE_BINARY);  
        for (int i = minx; i < width; i++) {  
            for (int j = miny; j < height; j++) {  
                ...
                {
//                	binaryBufferedImage.setRGB(i, j, pixel);  
                }
                System.out.println("i=" + i + ",j=" + j + ":(" + rgb[0] + ","  
                        + rgb[1] + "," + rgb[2] + ")");  
            }  
        }  
        ImageIO.write(bi, "jpg", new File("d:\\image", "ttttt.jpg"));
    }
}  
